...
@section('content')
    {{-- start modal --}}
    @for ($x = 1; $x <= 12; $x++)
        <div class="modal fade" id="comment_{{ $x }}" tabindex="-1" aria-labelledby="commentModalLabel"
            aria-hidden="true">
            ...
            <div class="row row-cols-lg-2 justify-content-center" id="box-head">
                ...
                <div class="col-8">
                    <div class="row row-cols-3 align-items-center">
                        ...
                        <div class="col-9 pe-0">Allow File Type - pptx, xlsx, xls, docx, doc, pdf, jpg, peg, png, gif
                        </div>
                    </div>
                </div>
            </div>
