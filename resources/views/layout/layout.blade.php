                                ...
                                <div class="collapse" id="executive-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ps-5 small">
                                        ...
                                        @if (in_array(auth()->user()->role, ['admin', 'powerUser', 'supervisor', 'executive']))
                                            <li><a href="{{ route('dept') }}" class="rounded">ข้อมูลหน่วยงาน✅</a></li>
                                        @endif
                                        @if (in_array(auth()->user()->role, ['admin', 'powerUser', 'supervisor', 'executive']))
                                            <li><a href="{{ route('budget') }}" class="rounded">รายการงบประมาณ✅</a></li>
                                        @endif
                                        @if (in_array(auth()->user()->role, ['admin', 'powerUser', 'supervisor', 'executive']))
                                            <li><a href="{{ route('all_project') }}" class="rounded">รายการโครงการทั้งหมด✅</a></li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
                        ...
                        <li class="sidebar-item">
                            <div class="item">
                                ...
                                <div class="collapse" id="report-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ps-5 small">
                                        @if (in_array(auth()->user()->role, ['admin', 'executive']))
                                            <li><a href="{{ route('dashboard_nimt') }}" class="rounded">ภาพรวมยุทธศาสตร์✅</a>
                                            </li>
                                        @endif
                                        @if (in_array(auth()->user()->role, ['admin', 'powerUser', 'supervisor', 'executive']))
                                            <li><a href="{{ route('org_chart') }}" class="rounded">แผนภาพยุทธศาสตร์✅</a>
                                            </li>
                                        @endif
                                        @if (in_array(auth()->user()->role, ['admin']))
                                            <li><a href="{{ route('dashboard_dept') }}" class="rounded">ภาพรวมหน่วยงาน✅</a></li>
                                        @endif
                                        {{-- @if (in_array(auth()->user()->role, ['admin', 'powerUser', 'supervisor', 'user']))
                                    ...
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ps-5 small">
                                        @if (in_array(auth()->user()->role, ['admin', 'powerUser', 'supervisor', 'executive']))
                                            <li><a href="{{ route('report_support') }}" class="rounded"
                                                    id="test">สรุปรายงานฝ่ายสนับสนุน✅</a></li>
                                        @endif
                                        @if (in_array(auth()->user()->role, ['admin', 'powerUser', 'supervisor', 'executive']))
                                            <li><a href="{{ route('report_technic') }}" class="rounded">สรุปรายงานฝ่ายเทคนิค✅</a></li>
                                        @endif
