...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@100;200;300;400&family=Roboto:ital,wght@0,100;0,500;0,700;1,100&family=Sarabun:wght@100;200&display=swap" rel="stylesheet">
            ...
            <a href="#" class="navbar-brand row d-flex align-items-center">
                <div class="col-3 ps-3">
                    <svg width="50" height="71" viewBox="0 0 50 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M25.1913 0.0884052L32.2501 29.404L0.146058 29.2902L11.7315 18.8429L25.1913 0.0884052Z" fill="#EA1B21"/>
                        <path d="M24.9842 58.541L0.146599 29.1624L32.2507 29.2762L27.6793 43.9053L24.9842 58.541Z" fill="#EA1B21"/>
                        ...
                        <path d="M25.0635 0.0881084L17.797 29.3529L49.9011 29.4667L38.39 18.9376L25.0635 0.0881084Z" fill="#2E3192"/>
                        <path d="M24.8561 58.5405L49.9014 29.3388L17.7973 29.225L22.2649 43.8861L24.8561 58.5405Z" fill="#2E3192"/>
