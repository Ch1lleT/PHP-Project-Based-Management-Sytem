...
<body>
    <div class="container-fluid p-0 d-flex min-vh-100 ">
        <div style="background-color: #337ab7; width:300px;" id="bdSidebar"
            class="d-flex flex-column flex-shrink-0 p-3 text-white offcanvas offcanvas-start overflow-y-auto">
        ...
        <div style="background-color: #337ab7;" id="hide-side"
